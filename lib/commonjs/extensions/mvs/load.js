...
function molstarTreeToEntry(plugin, tree, metadata, options) {
    var _a, _b, _c;
    const context = exports.MolstarLoadingContext.create();
    const snapshot = (0, load_generic_1.loadTreeVirtual)(plugin, tree, MolstarLoadingActions, context, { ...options, extensions: (_a = options === null || options === void 0 ? void 0 : options.extensions) !== null && _a !== void 0 ? _a : exports.BuiltinLoadingExtensions });
    snapshot.canvas3d = {
